...
# -----> I imported these modules manually <-----
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        self.scrapeops_api_key = settings.get("SCRAPOPS_API_KEY")
        self.scrapeops_endpoint = settings.get("SCRAPOPS_FAKE_USER_AGENT_ENDPOINT", "https://headers.scrapeops.io/v1/user-agents")
        self.scrapeops_fake_user_agent_active = settings.get("SCRAPOPS_FAKE_USER_AGENT_ENABLED", False)
